<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
    <div class="ebook-details">
        <div class="ebook-action m-b-10"> 
            ...
            <div class="pull-right">
                <span class="pull-left" style="margin-right: 5px;">
                    ...
                    <form method="POST" action="{{ route('ebooks.gameRun') }}">
                        ...
                        <input type="hidden" name="ebook_title" value="{{ $ebook->title }}">
                        <button type="submit" class="btn btn-primary btn-sm pull-left" style="margin-right: 5px;">Play now</button>
                    </form>
                @endif
                </span>
            ...
            <div class="clearfix">{{$ebookgameStatus}}</div>
        </div> 
        <h2 class="ebook-name">

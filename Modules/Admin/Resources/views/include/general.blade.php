...
(function () {
    ...
    CI.langs['admin::admin.buttons.save'] = '{{ clean(trans('admin::admin.buttons.save')) }}';
    CI.langs['admin::admin.save.confirmation'] = '{{ clean(trans('admin::admin.save.confirmation')) }}';
    CI.langs['admin::admin.save.confirmation_message'] = '{{ clean(trans('admin::admin.save.confirmation_message')) }}';
    CI.langs['admin::admin.save.btn_save'] = '{{ clean(trans('admin::admin.save.btn_save')) }}';
    CI.langs['admin::admin.save.btn_cancel'] = '{{ clean(trans('admin::admin.save.btn_cancel')) }}';
    CI.langs['admin::admin.save.success_message'] = '{{ clean(trans('admin::admin.save.success_message')) }}';

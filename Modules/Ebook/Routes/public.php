...
Route::post('ebooks/gameRun', 'EbookController@gameRunNow')->name('ebooks.gameRun');
Route::post('ebooks/gameAgain', 'EbookController@gameAgain')->name('ebooks.gameAgain');
Route::post('ebooks/gameFinish', 'EbookController@gameFinish')->name('ebooks.gameFinish');
